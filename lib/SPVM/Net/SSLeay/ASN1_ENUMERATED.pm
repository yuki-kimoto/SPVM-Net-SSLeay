...
Net::SSLeay::ASN1_ENUMERATED class in L<SPVM> represents L<ASN1_ENUMERATED|https://docs.openssl.org/master/man3/ASN1_INTEGER_get_int64/> data structure in OpenSSL.
