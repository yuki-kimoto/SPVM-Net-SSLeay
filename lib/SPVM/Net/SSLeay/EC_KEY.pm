...
Calls native L<EC_KEY_new_by_curve_name|https://docs.openssl.org/1.1.1/man3/EC_KEY_new/> function given the pointer value of the instance, $nid, creates a new L<Net::SSLeay::EC_KEY|SPVM::Net::SSLeay::EC_KEY> object, sets the pointer value of the new object to the return value of the native function, and returns the new object.
