...
Net::SSLeay::X509_NAME_ENTRY class in L<SPVM> represents L<X509_NAME_ENTRY|https://docs.openssl.org/master/man3/X509_new/> data structure in OpenSSL
...
Calls native L<X509_NAME_ENTRY_new|https://docs.openssl.org/master/man3/X509_dup/> function, creates a new  L<Net::SSLeay::X509_NAME_ENTRY|SPVM::Net::SSLeay::X509_NAME_ENTRY> object, sets the pointer value of the object to the return value of the native function, and returns the new object.
