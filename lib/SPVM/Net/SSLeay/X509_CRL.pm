...
Frees L<X509_CRL|https://docs.openssl.org/3.1/man3/X509_CRL_new/> object by calling native L<X509_CRL_free|https://docs.openssl.org/3.1/man3/X509_CRL_free/> function if C<no_free> flag of the instance is not a true value.
