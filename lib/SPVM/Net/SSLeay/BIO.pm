...
Calls native L<BIO_free|https://docs.openssl.org/master/man3/BIO_free> function given the pointer value of the instance unless C<no_free> flag of the instance is a true value.
