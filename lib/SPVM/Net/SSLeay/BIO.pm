...
Frees L<BIO|https://docs.openssl.org/1.0.2/man3/BIO_new> object by calling native L<BIO_free|https://docs.openssl.org/1.0.2/man3/BIO_free> function if C<no_free> flag of the instance is not a true value.
