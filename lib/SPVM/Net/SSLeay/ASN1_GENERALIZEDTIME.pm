...
Calls native L<ASN1_GENERALIZEDTIME_free|https://docs.openssl.org/master/man3/ASN1_GENERALIZEDTIME_free> function given the pointer value of the instance if C<no_free> flag of the instance is not a true value.
