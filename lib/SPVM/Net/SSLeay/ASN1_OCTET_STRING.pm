...
Calls native L<ASN1_STRING_get0_data|https://docs.openssl.org/master/man3/ASN1_STRING_length> function, converts its return value to a string which length is the return value of native L<ASN1_STRING_length|https://docs.openssl.org/master/man3/ASN1_STRING_length> function, and returns the string.
