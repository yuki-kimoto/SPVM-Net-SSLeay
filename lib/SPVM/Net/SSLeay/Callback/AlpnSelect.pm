...
Net::SSLeay::Callback::AlpnSelect interface in L<SPVM> represetns the callback for native L<SSL_CTX_set_alpn_select_cb|https://docs.openssl.org/1.1.1/man3/SSL_CTX_set_alpn_select_cb//> function in OpenSSL.
