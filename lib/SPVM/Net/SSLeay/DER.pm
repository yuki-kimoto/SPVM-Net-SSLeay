...
C<static method d2i_CERTID : L<Net::SSLeay::CERTID|SPVM::Net::SSLeay::CERTID> ($a_ref : L<Net::SSLeay::CERTID|SPVM::Net::SSLeay::CERTID>[], $ppin_ref : string[], $length : long);>

Calls native L<d2i_CERTID|https://docs.openssl.org/master/man3/d2i_X509> function given $a_ref, $ppin_ref, $length, and creates a new L<Net::SSLeay::CERTID|SPVM::Net::SSLeay::CERTID> object, sets the pointer value of the new object to the return value of the native function, and returns the new object.
...
If d2i_CERTID failed, an exception is thrown with C<eval_error_id> set to the basic type ID of L<Net::SSLeay::Error|SPVM::Net::SSLeay::Error> class.
