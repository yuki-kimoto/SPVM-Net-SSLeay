...
int32_t SPVM__Net__SSLeay__DER__d2i_OCSP_REQUEST_bio(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  OCSP_REQUEST* ret = d2i_OCSP_REQUEST_bio(bio, NULL);
  ...
  if (!ret) {
    ...
    env->die(env, stack, "[OpenSSL Error]d2i_OCSP_REQUEST_bio failed:%s.", ssl_error_string, __func__, FILE_NAME, __LINE__);
...
int32_t SPVM__Net__SSLeay__DER__d2i_OCSP_RESPONSE_bio(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  OCSP_RESPONSE* ret = d2i_OCSP_RESPONSE_bio(bio, NULL);
  ...
  if (!ret) {
    ...
    env->die(env, stack, "[OpenSSL Error]d2i_OCSP_RESPONSE_bio failed:%s.", ssl_error_string, __func__, FILE_NAME, __LINE__);
